...
import { AutoFormAIIcon } from "@/icons"

const inter = Inter({ subsets: ['latin'] });

const logo = (
  <div className="flex justify-center items-center" title="AutoFormAI">
    <AutoFormAIIcon alt="AutoFormAI" className="h-6 w-6" />
    <span className={`${inter.className} font-bold  ml-2 text-lg text-[#b700ff]`}>AutoFormAI</span>
  </div>
)
      ...
      <div className="flex justify-between items-start mb-24 flex-wrap gap-10">
        ...
        <List
          ...
          items={[
            ...
            { title: "Privacy Policy", url: "/docs/privacy-policy/" }
          ]}
        />
      </div>
...
export default {
  ...
  logo: logo,
  docsRepositoryBase:
    "https://github.com/happydrew/auto-form-ai-web/tree/main",
  color: {
    hue: 318,
    saturation: 100,
  },
